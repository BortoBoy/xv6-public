...
80100c51:	e8 8a 64 00 00       	call   801070e0 <copyout>
...
80100cb5:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  ...
  sp -= (3+argc+1) * 4;
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100cbb:	e8 20 64 00 00       	call   801070e0 <copyout>
...
80101ea8:	68 7e 79 10 80       	push   $0x8010797e
...
80102e07:	e8 e4 09 00 00       	call   801037f0 <cpuid>
80102e0c:	89 c3                	mov    %eax,%ebx
80102e0e:	e8 dd 09 00 00       	call   801037f0 <cpuid>
...
80102e22:	e8 79 2b 00 00       	call   801059a0 <idtinit>
  xchg(&(mycpu()->started), 1); // tell startothers() we're up
80102e27:	e8 44 09 00 00       	call   80103770 <mycpu>
...
80102e43:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102e46:	e8 75 3c 00 00       	call   80106ac0 <switchkvm>
  seginit();
80102e4b:	e8 70 3b 00 00       	call   801069c0 <seginit>
  lapicinit();
...
80102ea9:	e8 e2 2d 00 00       	call   80105c90 <uartinit>
  pinit();         // process table
80102eae:	e8 9d 08 00 00       	call   80103750 <pinit>
  tvinit();        // trap vectors
80102eb3:	e8 48 2a 00 00       	call   80105900 <tvinit>
  binit();         // buffer cache
...
80102ef8:	e8 73 08 00 00       	call   80103770 <mycpu>
...
80102f75:	e8 c6 08 00 00       	call   80103840 <userinit>
...
801035fc:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  ...
  release(&ptable.lock);
80103602:	e8 89 10 00 00       	call   80104690 <release>
...
80103624:	89 53 18             	mov    %edx,0x18(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
80103627:	c7 40 14 f2 58 10 80 	movl   $0x801058f2,0x14(%eax)
...
80103633:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103636:	e8 a5 10 00 00       	call   801046e0 <memset>
...
801036c9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
801036cc:	8b 55 08             	mov    0x8(%ebp),%edx
801036cf:	89 df                	mov    %ebx,%edi
801036d1:	c1 ef 16             	shr    $0x16,%edi
801036d4:	8d 3c ba             	lea    (%edx,%edi,4),%edi
  if(*pde & PTE_P){
801036d7:	8b 07                	mov    (%edi),%eax
801036d9:	a8 01                	test   $0x1,%al
801036db:	74 23                	je     80103700 <walkpgdir+0x40>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
801036dd:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801036e2:	8d b0 00 00 00 80    	lea    -0x80000000(%eax),%esi
...
801036e8:	8d 65 f4             	lea    -0xc(%ebp),%esp
  ...
  return &pgtab[PTX(va)];
801036eb:	c1 eb 0a             	shr    $0xa,%ebx
801036ee:	81 e3 fc 0f 00 00    	and    $0xffc,%ebx
801036f4:	8d 04 1e             	lea    (%esi,%ebx,1),%eax
}
801036f7:	5b                   	pop    %ebx
801036f8:	5e                   	pop    %esi
801036f9:	5f                   	pop    %edi
...
80103705:	74 31                	je     80103738 <walkpgdir+0x78>
80103707:	e8 84 ed ff ff       	call   80102490 <kalloc>
8010370c:	85 c0                	test   %eax,%eax
8010370e:	89 c6                	mov    %eax,%esi
80103710:	74 26                	je     80103738 <walkpgdir+0x78>
      return 0;
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
80103712:	83 ec 04             	sub    $0x4,%esp
80103715:	68 00 10 00 00       	push   $0x1000
8010371a:	6a 00                	push   $0x0
8010371c:	50                   	push   %eax
8010371d:	e8 be 0f 00 00       	call   801046e0 <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80103722:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
80103728:	83 c4 10             	add    $0x10,%esp
8010372b:	83 c8 07             	or     $0x7,%eax
8010372e:	89 07                	mov    %eax,(%edi)
80103730:	eb b6                	jmp    801036e8 <walkpgdir+0x28>
...
80103740:	5d                   	pop    %ebp
80103741:	c3                   	ret    
80103742:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
8010377a:	75 5b                	jne    801037d7 <mycpu+0x67>
  ...
  apicid = lapicid();
8010377c:	e8 6f ef ff ff       	call   801026f0 <lapicid>
...
801037cd:	68 dc 76 10 80       	push   $0x801076dc
...
801037da:	68 10 78 10 80       	push   $0x80107810
...
80103814:	83 ec 04             	sub    $0x4,%esp
  ...
  struct proc *p;
  pushcli();
80103817:	e8 14 0d 00 00       	call   80104530 <pushcli>
  c = mycpu();
...
801038e5:	e8 f6 0f 00 00       	call   801048e0 <safestrcpy>
  p->cwd = namei("/");
...
80103913:	e8 78 0d 00 00       	call   80104690 <release>
}
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103938:	e8 f3 0b 00 00       	call   80104530 <pushcli>
  c = mycpu();
8010393d:	e8 2e fe ff ff       	call   80103770 <mycpu>
  p = c->proc;
80103942:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103948:	e8 d3 0c 00 00       	call   80104620 <popcli>
{
  uint sz;
  struct proc *curproc = myproc();
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
801039b9:	e8 72 0b 00 00       	call   80104530 <pushcli>
  c = mycpu();
801039be:	e8 ad fd ff ff       	call   80103770 <mycpu>
  p = c->proc;
801039c3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801039c9:	e8 52 0c 00 00       	call   80104620 <popcli>
  int i, pid;
  struct proc *np;
  struct proc *curproc = myproc();
...
80103a61:	e8 7a 0e 00 00       	call   801048e0 <safestrcpy>
...
80103a9a:	eb f1                	jmp    80103a8d <fork+0xdd>
  }
...
80103ac0:	eb cb                	jmp    80103a8d <fork+0xdd>
...
80103afe:	e8 6d 0a 00 00       	call   80104570 <acquire>
...
80103b13:	81 fb 54 4c 11 80    	cmp    $0x80114c54,%ebx
80103b19:	74 45                	je     80103b60 <scheduler+0x90>
      if(p->state != RUNNABLE)
...
80103b2b:	83 c3 7c             	add    $0x7c,%ebx
      ...
      c->proc = p;
      switchuvm(p);
80103b2e:	e8 ad 2f 00 00       	call   80106ae0 <switchuvm>
      p->state = RUNNING;
...
80103b39:	c7 43 90 04 00 00 00 	movl   $0x4,-0x70(%ebx)
      ...
      swtch(&(c->scheduler), p->context);
80103b40:	e8 f6 0d 00 00       	call   8010493b <swtch>
      switchkvm();
80103b45:	e8 76 2f 00 00       	call   80106ac0 <switchkvm>
...
80103b4a:	83 c4 10             	add    $0x10,%esp
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b4d:	81 fb 54 4c 11 80    	cmp    $0x80114c54,%ebx
      swtch(&(c->scheduler), p->context);
      switchkvm();
...
80103b5a:	00 00 00 
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b5d:	75 bc                	jne    80103b1b <scheduler+0x4b>
80103b5f:	90                   	nop
...
80103b63:	68 20 2d 11 80       	push   $0x80112d20
80103b68:	e8 23 0b 00 00       	call   80104690 <release>
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103b85:	e8 a6 09 00 00       	call   80104530 <pushcli>
  c = mycpu();
80103b8a:	e8 e1 fb ff ff       	call   80103770 <mycpu>
  p = c->proc;
80103b8f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b95:	e8 86 0a 00 00       	call   80104620 <popcli>
sched(void)
{
  int intena;
...
80103ba2:	e8 49 09 00 00       	call   801044f0 <holding>
...
80103be3:	e8 53 0d 00 00       	call   8010493b <swtch>
  mycpu()->intena = intena;
...
80103c00:	68 10 77 10 80       	push   $0x80107710
...
80103c0d:	68 3c 77 10 80       	push   $0x8010773c
...
80103c1a:	68 2e 77 10 80       	push   $0x8010772e
...
80103c27:	68 22 77 10 80       	push   $0x80107722
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103c49:	e8 e2 08 00 00       	call   80104530 <pushcli>
  c = mycpu();
80103c4e:	e8 1d fb ff ff       	call   80103770 <mycpu>
  p = c->proc;
80103c53:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103c59:	e8 c2 09 00 00       	call   80104620 <popcli>
{
  struct proc *curproc = myproc();
  struct proc *p;
  int fd;
...
80103cb2:	e8 b9 08 00 00       	call   80104570 <acquire>
...
80103d4d:	68 5d 77 10 80       	push   $0x8010775d
...
80103d5a:	68 50 77 10 80       	push   $0x80107750
...
80103d7c:	e8 ef 07 00 00       	call   80104570 <acquire>
// while reading proc from the cpu structure
struct proc*
myproc(void) {
  struct cpu *c;
  struct proc *p;
  pushcli();
80103d81:	e8 aa 07 00 00       	call   80104530 <pushcli>
  c = mycpu();
80103d86:	e8 e5 f9 ff ff       	call   80103770 <mycpu>
  p = c->proc;
80103d8b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103d91:	e8 8a 08 00 00       	call   80104620 <popcli>
// Give up the CPU for one scheduling round.
void
yield(void)
{
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103dcf:	e8 5c 07 00 00       	call   80104530 <pushcli>
  c = mycpu();
80103dd4:	e8 97 f9 ff ff       	call   80103770 <mycpu>
  p = c->proc;
80103dd9:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ddf:	e8 3c 08 00 00       	call   80104620 <popcli>
void
sleep(void *chan, struct spinlock *lk)
{
  struct proc *p = myproc();
...
80103e00:	e8 6b 07 00 00       	call   80104570 <acquire>
    release(lk);
...
80103e3b:	5d                   	pop    %ebp
  ...
  if(lk != &ptable.lock){  //DOC: sleeplock2
    release(&ptable.lock);
    acquire(lk);
80103e3c:	e9 2f 07 00 00       	jmp    80104570 <acquire>
...
80103e69:	68 6f 77 10 80       	push   $0x8010776f
...
80103e76:	68 69 77 10 80       	push   $0x80107769
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103e85:	e8 a6 06 00 00       	call   80104530 <pushcli>
  c = mycpu();
80103e8a:	e8 e1 f8 ff ff       	call   80103770 <mycpu>
  p = c->proc;
80103e8f:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103e95:	e8 86 07 00 00       	call   80104620 <popcli>
{
  struct proc *p;
  int havekids, pid;
  struct proc *curproc = myproc();
...
80103ea2:	e8 c9 06 00 00       	call   80104570 <acquire>
...
80103f10:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103f17:	e8 44 2f 00 00       	call   80106e60 <freevm>
        p->pid = 0;
...
80103f43:	e8 48 07 00 00       	call   80104690 <release>
        return pid;
...
80103f5c:	e8 2f 07 00 00       	call   80104690 <release>
      return -1;
...
80103f7f:	e8 ec 05 00 00       	call   80104570 <acquire>
...
wakeup(void *chan)
{
  ...
  wakeup1(chan);
  release(&ptable.lock);
80103fc1:	e9 ca 06 00 00       	jmp    80104690 <release>
...
80103fdf:	e8 8c 05 00 00       	call   80104570 <acquire>
...
80104014:	e8 77 06 00 00       	call   80104690 <release>
      return 0;
...
80104040:	e8 4b 06 00 00       	call   80104690 <release>
  return -1;
...
void task_1(pde_t *page_dir_pointer){
80104068:	83 ec 24             	sub    $0x24,%esp
8010406b:	8b 75 08             	mov    0x8(%ebp),%esi
  cprintf("%s","Page Table:\n");
8010406e:	68 80 77 10 80       	push   $0x80107780
80104073:	68 e0 77 10 80       	push   $0x801077e0
80104078:	e8 e3 c5 ff ff       	call   80100660 <cprintf>
  cprintf("  Memory location of page directory = %p\n",page_dir_pointer);
8010407d:	59                   	pop    %ecx
8010407e:	5b                   	pop    %ebx
8010407f:	56                   	push   %esi
80104080:	68 38 78 10 80       	push   $0x80107838
  uint dir_i=0;
  uint table_i=0;
80104085:	31 db                	xor    %ebx,%ebx
  return -1;
}
...
void task_1(pde_t *page_dir_pointer){
  cprintf("%s","Page Table:\n");
  cprintf("  Memory location of page directory = %p\n",page_dir_pointer);
80104087:	e8 d4 c5 ff ff       	call   80100660 <cprintf>
  uint dir_i=0;
...
8010408e:	83 c4 10             	add    $0x10,%esp
  uint dir_i=0;
80104091:	89 fe                	mov    %edi,%esi
80104093:	eb 12                	jmp    801040a7 <task_1+0x47>
80104095:	8d 76 00             	lea    0x0(%esi),%esi
  uint table_i=0;
  int ok;
  for(;dir_i < NPDENTRIES;dir_i++){
80104098:	83 c6 01             	add    $0x1,%esi
8010409b:	81 fe 00 04 00 00    	cmp    $0x400,%esi
801040a1:	0f 84 b4 00 00 00    	je     8010415b <task_1+0xfb>
    if( ( page_dir_pointer[dir_i] & PTE_P) && (page_dir_pointer[dir_i]& PTE_U)  ){
801040a7:	8b 3c b2             	mov    (%edx,%esi,4),%edi
801040aa:	89 f8                	mov    %edi,%eax
801040ac:	83 e0 05             	and    $0x5,%eax
801040af:	83 f8 05             	cmp    $0x5,%eax
801040b2:	75 e4                	jne    80104098 <task_1+0x38>
      pde_t* page_table_entries= (pde_t*) PTE_ADDR( P2V(page_dir_pointer[dir_i]) );
801040b4:	81 c7 00 00 00 80    	add    $0x80000000,%edi
801040ba:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
      ok=0;
      for(;table_i < NPTENTRIES;table_i++){
801040c0:	81 fb ff 03 00 00    	cmp    $0x3ff,%ebx
801040c6:	77 d0                	ja     80104098 <task_1+0x38>
          if(!ok){
      ...
      for(;table_i < NPTENTRIES;table_i++){
        if (( page_table_entries[table_i] & PTE_P) && (page_table_entries[table_i]& PTE_U)){
          if(!ok){
            cprintf("  pdir PTE %d, %d :\n", dir_i , page_dir_pointer[dir_i]>>12 );
            cprintf("  Memory location of page table = %p\n",PTE_ADDR( V2P((void*)page_table_entries)) );
801040ca:	89 75 e0             	mov    %esi,-0x20(%ebp)
            ok=1;
          }
          pde_t* ppn=walkpgdir(page_dir_pointer,(void*)PGADDR(dir_i,table_i,0),0);
801040cd:	31 c9                	xor    %ecx,%ecx
801040cf:	c1 e0 16             	shl    $0x16,%eax
      ok=0;
      for(;table_i < NPTENTRIES;table_i++){
        if (( page_table_entries[table_i] & PTE_P) && (page_table_entries[table_i]& PTE_U)){
          if(!ok){
            cprintf("  pdir PTE %d, %d :\n", dir_i , page_dir_pointer[dir_i]>>12 );
            cprintf("  Memory location of page table = %p\n",PTE_ADDR( V2P((void*)page_table_entries)) );
801040d2:	89 fe                	mov    %edi,%esi
            ok=1;
          }
          pde_t* ppn=walkpgdir(page_dir_pointer,(void*)PGADDR(dir_i,table_i,0),0);
801040d4:	89 45 e4             	mov    %eax,-0x1c(%ebp)
      ok=0;
      for(;table_i < NPTENTRIES;table_i++){
        if (( page_table_entries[table_i] & PTE_P) && (page_table_entries[table_i]& PTE_U)){
          if(!ok){
            cprintf("  pdir PTE %d, %d :\n", dir_i , page_dir_pointer[dir_i]>>12 );
            cprintf("  Memory location of page table = %p\n",PTE_ADDR( V2P((void*)page_table_entries)) );
801040d7:	8d 87 00 00 00 80    	lea    -0x80000000(%edi),%eax
801040dd:	89 d7                	mov    %edx,%edi
801040df:	89 45 dc             	mov    %eax,-0x24(%ebp)
801040e2:	eb 0f                	jmp    801040f3 <task_1+0x93>
801040e4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  for(;dir_i < NPDENTRIES;dir_i++){
    if( ( page_dir_pointer[dir_i] & PTE_P) && (page_dir_pointer[dir_i]& PTE_U)  ){
      ...
      ok=0;
      for(;table_i < NPTENTRIES;table_i++){
801040e8:	83 c3 01             	add    $0x1,%ebx
801040eb:	81 fb 00 04 00 00    	cmp    $0x400,%ebx
801040f1:	74 54                	je     80104147 <task_1+0xe7>
        if (( page_table_entries[table_i] & PTE_P) && (page_table_entries[table_i]& PTE_U)){
801040f3:	8b 04 9e             	mov    (%esi,%ebx,4),%eax
801040f6:	83 e0 05             	and    $0x5,%eax
801040f9:	83 f8 05             	cmp    $0x5,%eax
801040fc:	75 ea                	jne    801040e8 <task_1+0x88>
          if(!ok){
801040fe:	85 c9                	test   %ecx,%ecx
80104100:	0f 84 42 01 00 00    	je     80104248 <task_1+0x1e8>
            cprintf("  pdir PTE %d, %d :\n", dir_i , page_dir_pointer[dir_i]>>12 );
            cprintf("  Memory location of page table = %p\n",PTE_ADDR( V2P((void*)page_table_entries)) );
            ok=1;
          }
...
8010410b:	c1 e0 0c             	shl    $0xc,%eax
8010410e:	0b 45 e4             	or     -0x1c(%ebp),%eax
80104111:	6a 00                	push   $0x0
80104113:	50                   	push   %eax
80104114:	57                   	push   %edi
80104115:	e8 a6 f5 ff ff       	call   801036c0 <walkpgdir>
          cprintf("    ptbl PTE %d, %d, %p\n", table_i, *ppn>>12 ,PTE_ADDR(*ppn));
8010411a:	8b 00                	mov    (%eax),%eax
8010411c:	89 c1                	mov    %eax,%ecx
8010411e:	c1 e8 0c             	shr    $0xc,%eax
80104121:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
80104127:	51                   	push   %ecx
80104128:	50                   	push   %eax
80104129:	53                   	push   %ebx
8010412a:	68 a2 77 10 80       	push   $0x801077a2
  int ok;
  for(;dir_i < NPDENTRIES;dir_i++){
    if( ( page_dir_pointer[dir_i] & PTE_P) && (page_dir_pointer[dir_i]& PTE_U)  ){
      pde_t* page_table_entries= (pde_t*) PTE_ADDR( P2V(page_dir_pointer[dir_i]) );
...
80104137:	83 c4 20             	add    $0x20,%esp
  int ok;
  for(;dir_i < NPDENTRIES;dir_i++){
    if( ( page_dir_pointer[dir_i] & PTE_P) && (page_dir_pointer[dir_i]& PTE_U)  ){
      pde_t* page_table_entries= (pde_t*) PTE_ADDR( P2V(page_dir_pointer[dir_i]) );
      ok=0;
      for(;table_i < NPTENTRIES;table_i++){
8010413a:	81 fb 00 04 00 00    	cmp    $0x400,%ebx
            cprintf("  pdir PTE %d, %d :\n", dir_i , page_dir_pointer[dir_i]>>12 );
            cprintf("  Memory location of page table = %p\n",PTE_ADDR( V2P((void*)page_table_entries)) );
            ok=1;
          }
          pde_t* ppn=walkpgdir(page_dir_pointer,(void*)PGADDR(dir_i,table_i,0),0);
          cprintf("    ptbl PTE %d, %d, %p\n", table_i, *ppn>>12 ,PTE_ADDR(*ppn));
80104140:	b9 01 00 00 00       	mov    $0x1,%ecx
  int ok;
  for(;dir_i < NPDENTRIES;dir_i++){
    if( ( page_dir_pointer[dir_i] & PTE_P) && (page_dir_pointer[dir_i]& PTE_U)  ){
      pde_t* page_table_entries= (pde_t*) PTE_ADDR( P2V(page_dir_pointer[dir_i]) );
      ok=0;
      for(;table_i < NPTENTRIES;table_i++){
80104145:	75 ac                	jne    801040f3 <task_1+0x93>
80104147:	8b 75 e0             	mov    -0x20(%ebp),%esi
8010414a:	89 fa                	mov    %edi,%edx
  cprintf("%s","Page Table:\n");
  cprintf("  Memory location of page directory = %p\n",page_dir_pointer);
  uint dir_i=0;
  uint table_i=0;
  int ok;
  for(;dir_i < NPDENTRIES;dir_i++){
8010414c:	83 c6 01             	add    $0x1,%esi
8010414f:	81 fe 00 04 00 00    	cmp    $0x400,%esi
80104155:	0f 85 4c ff ff ff    	jne    801040a7 <task_1+0x47>
          cprintf("    ptbl PTE %d, %d, %p\n", table_i, *ppn>>12 ,PTE_ADDR(*ppn));
          }
       }
     }
...
80104160:	31 db                	xor    %ebx,%ebx
   ...
   cprintf("%s","Page Mappings:\n");
80104162:	68 bb 77 10 80       	push   $0x801077bb
80104167:	68 e0 77 10 80       	push   $0x801077e0
   table_i=0;
   dir_i=0;
8010416c:	31 ff                	xor    %edi,%edi
          cprintf("    ptbl PTE %d, %d, %p\n", table_i, *ppn>>12 ,PTE_ADDR(*ppn));
          }
       }
     }
...
80104173:	83 c4 10             	add    $0x10,%esp
   table_i=0;
   dir_i=0;
80104176:	89 f1                	mov    %esi,%ecx
80104178:	eb 15                	jmp    8010418f <task_1+0x12f>
8010417a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
   for(;dir_i < NPDENTRIES;dir_i++){
80104180:	83 c7 01             	add    $0x1,%edi
80104183:	81 ff 00 04 00 00    	cmp    $0x400,%edi
80104189:	0f 84 ad 00 00 00    	je     8010423c <task_1+0x1dc>
     if( ( page_dir_pointer[dir_i] & PTE_P) && (page_dir_pointer[dir_i]& PTE_U)  ){ 
8010418f:	8b 34 b9             	mov    (%ecx,%edi,4),%esi
80104192:	89 f0                	mov    %esi,%eax
80104194:	83 e0 05             	and    $0x5,%eax
80104197:	83 f8 05             	cmp    $0x5,%eax
8010419a:	75 e4                	jne    80104180 <task_1+0x120>

       pde_t* page_table_entries= (pde_t*) PTE_ADDR( P2V(page_dir_pointer[dir_i]) );
8010419c:	81 c6 00 00 00 80    	add    $0x80000000,%esi
801041a2:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi

       for(;table_i < NPTENTRIES;table_i++){
801041a8:	81 fb ff 03 00 00    	cmp    $0x3ff,%ebx
801041ae:	77 d0                	ja     80104180 <task_1+0x120>
           if (( page_table_entries[table_i] & PTE_P) && (page_table_entries[table_i]& PTE_U)){
             pde_t*  ppn=walkpgdir(page_dir_pointer,(void*)PGADDR(dir_i,table_i,0),0);
801041b0:	89 f8                	mov    %edi,%eax
            
             cprintf(" %d -> %p\n", (dir_i<<10)+table_i, PTE_ADDR(*ppn));
801041b2:	89 7d dc             	mov    %edi,-0x24(%ebp)
       ...
       for(;table_i < NPTENTRIES;table_i++){
           if (( page_table_entries[table_i] & PTE_P) && (page_table_entries[table_i]& PTE_U)){
             pde_t*  ppn=walkpgdir(page_dir_pointer,(void*)PGADDR(dir_i,table_i,0),0);
801041b5:	c1 e0 16             	shl    $0x16,%eax
801041b8:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            
             cprintf(" %d -> %p\n", (dir_i<<10)+table_i, PTE_ADDR(*ppn));
801041bb:	89 f8                	mov    %edi,%eax
801041bd:	89 cf                	mov    %ecx,%edi
801041bf:	c1 e0 0a             	shl    $0xa,%eax
801041c2:	89 45 e0             	mov    %eax,-0x20(%ebp)
801041c5:	eb 14                	jmp    801041db <task_1+0x17b>
...
801041c9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
   for(;dir_i < NPDENTRIES;dir_i++){
     if( ( page_dir_pointer[dir_i] & PTE_P) && (page_dir_pointer[dir_i]& PTE_U)  ){ 
       ...
       for(;table_i < NPTENTRIES;table_i++){
801041d0:	83 c3 01             	add    $0x1,%ebx
801041d3:	81 fb 00 04 00 00    	cmp    $0x400,%ebx
801041d9:	74 4d                	je     80104228 <task_1+0x1c8>
           if (( page_table_entries[table_i] & PTE_P) && (page_table_entries[table_i]& PTE_U)){
801041db:	8b 04 9e             	mov    (%esi,%ebx,4),%eax
801041de:	83 e0 05             	and    $0x5,%eax
801041e1:	83 f8 05             	cmp    $0x5,%eax
801041e4:	75 ea                	jne    801041d0 <task_1+0x170>
             pde_t*  ppn=walkpgdir(page_dir_pointer,(void*)PGADDR(dir_i,table_i,0),0);
801041e6:	89 d8                	mov    %ebx,%eax
801041e8:	83 ec 04             	sub    $0x4,%esp
801041eb:	c1 e0 0c             	shl    $0xc,%eax
801041ee:	0b 45 e4             	or     -0x1c(%ebp),%eax
801041f1:	6a 00                	push   $0x0
801041f3:	50                   	push   %eax
801041f4:	57                   	push   %edi
801041f5:	e8 c6 f4 ff ff       	call   801036c0 <walkpgdir>
            
             cprintf(" %d -> %p\n", (dir_i<<10)+table_i, PTE_ADDR(*ppn));
801041fa:	8b 00                	mov    (%eax),%eax
801041fc:	83 c4 0c             	add    $0xc,%esp
801041ff:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80104204:	50                   	push   %eax
80104205:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104208:	01 d8                	add    %ebx,%eax
   for(;dir_i < NPDENTRIES;dir_i++){
     if( ( page_dir_pointer[dir_i] & PTE_P) && (page_dir_pointer[dir_i]& PTE_U)  ){ 
       ...
       for(;table_i < NPTENTRIES;table_i++){
8010420a:	83 c3 01             	add    $0x1,%ebx
           if (( page_table_entries[table_i] & PTE_P) && (page_table_entries[table_i]& PTE_U)){
             pde_t*  ppn=walkpgdir(page_dir_pointer,(void*)PGADDR(dir_i,table_i,0),0);
            
             cprintf(" %d -> %p\n", (dir_i<<10)+table_i, PTE_ADDR(*ppn));
8010420d:	50                   	push   %eax
8010420e:	68 cb 77 10 80       	push   $0x801077cb
...
80104218:	83 c4 10             	add    $0x10,%esp
   for(;dir_i < NPDENTRIES;dir_i++){
     if( ( page_dir_pointer[dir_i] & PTE_P) && (page_dir_pointer[dir_i]& PTE_U)  ){ 
       ...
       for(;table_i < NPTENTRIES;table_i++){
8010421b:	81 fb 00 04 00 00    	cmp    $0x400,%ebx
80104221:	75 b8                	jne    801041db <task_1+0x17b>
80104223:	90                   	nop
80104224:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104228:	89 f9                	mov    %edi,%ecx
8010422a:	8b 7d dc             	mov    -0x24(%ebp),%edi
     }
   }
   cprintf("%s","Page Mappings:\n");
   table_i=0;
   dir_i=0;
   for(;dir_i < NPDENTRIES;dir_i++){
8010422d:	83 c7 01             	add    $0x1,%edi
80104230:	81 ff 00 04 00 00    	cmp    $0x400,%edi
80104236:	0f 85 53 ff ff ff    	jne    8010418f <task_1+0x12f>
             cprintf(" %d -> %p\n", (dir_i<<10)+table_i, PTE_ADDR(*ppn));
           }
       }
     }
...
80104244:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      ...
      for(;table_i < NPTENTRIES;table_i++){
        if (( page_table_entries[table_i] & PTE_P) && (page_table_entries[table_i]& PTE_U)){
          if(!ok){
            cprintf("  pdir PTE %d, %d :\n", dir_i , page_dir_pointer[dir_i]>>12 );
80104248:	8b 55 e0             	mov    -0x20(%ebp),%edx
8010424b:	83 ec 04             	sub    $0x4,%esp
8010424e:	8b 04 97             	mov    (%edi,%edx,4),%eax
80104251:	89 45 d8             	mov    %eax,-0x28(%ebp)
80104254:	c1 e8 0c             	shr    $0xc,%eax
80104257:	50                   	push   %eax
80104258:	52                   	push   %edx
80104259:	68 8d 77 10 80       	push   $0x8010778d
8010425e:	e8 fd c3 ff ff       	call   80100660 <cprintf>
            cprintf("  Memory location of page table = %p\n",PTE_ADDR( V2P((void*)page_table_entries)) );
80104263:	58                   	pop    %eax
80104264:	5a                   	pop    %edx
80104265:	ff 75 dc             	pushl  -0x24(%ebp)
80104268:	68 64 78 10 80       	push   $0x80107864
8010426d:	e8 ee c3 ff ff       	call   80100660 <cprintf>
80104272:	83 c4 10             	add    $0x10,%esp
80104275:	e9 8c fe ff ff       	jmp    80104106 <task_1+0xa6>
...
80104291:	eb 2d                	jmp    801042c0 <procdump+0x40>
80104293:	90                   	nop
...
8010429b:	68 97 7b 10 80       	push   $0x80107b97
801042a0:	e8 bb c3 ff ff       	call   80100660 <cprintf>
    task_1(p->pgdir);
801042a5:	58                   	pop    %eax
801042a6:	ff 73 98             	pushl  -0x68(%ebx)
801042a9:	e8 b2 fd ff ff       	call   80104060 <task_1>
801042ae:	83 c4 10             	add    $0x10,%esp
801042b1:	83 c3 7c             	add    $0x7c,%ebx
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801042b4:	81 fb c0 4c 11 80    	cmp    $0x80114cc0,%ebx
801042ba:	0f 84 90 00 00 00    	je     80104350 <procdump+0xd0>
    if(p->state == UNUSED)
801042c0:	8b 43 a0             	mov    -0x60(%ebx),%eax
801042c3:	85 c0                	test   %eax,%eax
801042c5:	74 ea                	je     801042b1 <procdump+0x31>
      continue;
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801042c7:	83 f8 05             	cmp    $0x5,%eax
      state = states[p->state];
    else
      state = "???";
801042ca:	ba d6 77 10 80       	mov    $0x801077d6,%edx
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
    if(p->state == UNUSED)
      continue;
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801042cf:	77 11                	ja     801042e2 <procdump+0x62>
801042d1:	8b 14 85 8c 78 10 80 	mov    -0x7fef8774(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
801042d8:	b8 d6 77 10 80       	mov    $0x801077d6,%eax
801042dd:	85 d2                	test   %edx,%edx
801042df:	0f 44 d0             	cmove  %eax,%edx
    cprintf("%d %s %s", p->pid, state, p->name);
801042e2:	53                   	push   %ebx
801042e3:	52                   	push   %edx
801042e4:	ff 73 a4             	pushl  -0x5c(%ebx)
801042e7:	68 da 77 10 80       	push   $0x801077da
801042ec:	e8 6f c3 ff ff       	call   80100660 <cprintf>
    if(p->state == SLEEPING){
801042f1:	83 c4 10             	add    $0x10,%esp
801042f4:	83 7b a0 02          	cmpl   $0x2,-0x60(%ebx)
801042f8:	75 9e                	jne    80104298 <procdump+0x18>
      getcallerpcs((uint*)p->context->ebp+2, pc);
801042fa:	8d 45 c0             	lea    -0x40(%ebp),%eax
801042fd:	83 ec 08             	sub    $0x8,%esp
80104300:	8d 7d c0             	lea    -0x40(%ebp),%edi
80104303:	50                   	push   %eax
80104304:	8b 43 b0             	mov    -0x50(%ebx),%eax
80104307:	8b 40 0c             	mov    0xc(%eax),%eax
8010430a:	83 c0 08             	add    $0x8,%eax
8010430d:	50                   	push   %eax
8010430e:	e8 7d 01 00 00       	call   80104490 <getcallerpcs>
...
80104324:	0f 84 6e ff ff ff    	je     80104298 <procdump+0x18>
        cprintf(" %p", pc[i]);
8010432a:	83 ec 08             	sub    $0x8,%esp
8010432d:	83 c7 04             	add    $0x4,%edi
80104330:	52                   	push   %edx
80104331:	68 c1 71 10 80       	push   $0x801071c1
80104336:	e8 25 c3 ff ff       	call   80100660 <cprintf>
    else
      state = "???";
    cprintf("%d %s %s", p->pid, state, p->name);
    if(p->state == SLEEPING){
...
8010433e:	39 f7                	cmp    %esi,%edi
80104340:	75 de                	jne    80104320 <procdump+0xa0>
80104342:	e9 51 ff ff ff       	jmp    80104298 <procdump+0x18>
...
8010436a:	68 a4 78 10 80       	push   $0x801078a4
...
80104424:	e8 47 fb ff ff       	call   80103f70 <wakeup>
  release(&lk->lk);
...
80104513:	e8 58 f2 ff ff       	call   80103770 <mycpu>
...
80104539:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
8010453a:	e8 31 f2 ff ff       	call   80103770 <mycpu>
...
8010454f:	e8 1c f2 ff ff       	call   80103770 <mycpu>
80104554:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
8010455a:	e8 11 f2 ff ff       	call   80103770 <mycpu>
...
80104603:	e8 68 f1 ff ff       	call   80103770 <mycpu>
...
80104613:	68 af 78 10 80       	push   $0x801078af
...
80104645:	e8 26 f1 ff ff       	call   80103770 <mycpu>
...
80104675:	68 ce 78 10 80       	push   $0x801078ce
...
80104682:	68 b7 78 10 80       	push   $0x801078b7
...
801046a1:	68 d5 78 10 80       	push   $0x801078d5
...
801046b3:	e8 b8 f0 ff ff       	call   80103770 <mycpu>
...
80104957:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010495a:	e8 b1 ee ff ff       	call   80103810 <myproc>
...
801049f5:	e8 16 ee ff ff       	call   80103810 <myproc>
...
{
  struct proc *curproc = myproc();
80104a06:	e8 05 ee ff ff       	call   80103810 <myproc>
...
80104a48:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80104a4b:	e8 c0 ed ff ff       	call   80103810 <myproc>
...
80104ae4:	53                   	push   %ebx
  int num;
  struct proc *curproc = myproc();
80104ae5:	e8 26 ed ff ff       	call   80103810 <myproc>
...
80104af5:	83 fa 14             	cmp    $0x14,%edx
80104af8:	77 1e                	ja     80104b18 <syscall+0x38>
80104afa:	8b 14 85 00 79 10 80 	mov    -0x7fef8700(,%eax,4),%edx
...
80104b20:	68 dd 78 10 80       	push   $0x801078dd
...
80104c84:	68 74 79 10 80       	push   $0x80107974
...
80104c9c:	68 73 79 10 80       	push   $0x80107973
...
80104cb1:	68 67 79 10 80       	push   $0x80107967
...
80104cbe:	68 76 79 10 80       	push   $0x80107976
...
80104ccb:	68 58 79 10 80       	push   $0x80107958
...
80104d04:	e8 07 eb ff ff       	call   80103810 <myproc>
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
80104d6b:	e8 a0 ea ff ff       	call   80103810 <myproc>
...
80104ea3:	78 2b                	js     80104ed0 <sys_close+0x40>
    return -1;
  myproc()->ofile[fd] = 0;
80104ea5:	e8 66 e9 ff ff       	call   80103810 <myproc>
...
801050dd:	58                   	pop    %eax
801050de:	5a                   	pop    %edx
801050df:	68 74 79 10 80       	push   $0x80107974
...
801050f8:	68 73 79 10 80       	push   $0x80107973
...
8010524d:	68 98 79 10 80       	push   $0x80107998
...
8010525a:	68 aa 79 10 80       	push   $0x801079aa
...
80105267:	68 86 79 10 80       	push   $0x80107986
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
80105303:	e8 08 e5 ff ff       	call   80103810 <myproc>
80105308:	90                   	nop
...
801054d5:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
801054d8:	e8 33 e3 ff ff       	call   80103810 <myproc>
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
801056e2:	e8 29 e1 ff ff       	call   80103810 <myproc>
...
801056fe:	75 f0                	jne    801056f0 <sys_pipe+0x90>
  ...
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
    if(fd0 >= 0)
      myproc()->ofile[fd0] = 0;
80105700:	e8 0b e1 ff ff       	call   80103810 <myproc>
...
{
  return fork();
80105734:	e9 77 e2 ff ff       	jmp    801039b0 <fork>
...
80105743:	83 ec 08             	sub    $0x8,%esp
  exit();
80105746:	e8 f5 e4 ff ff       	call   80103c40 <exit>
...
{
  return wait();
80105754:	e9 27 e7 ff ff       	jmp    80103e80 <wait>
...
8010577e:	e8 4d e8 ff ff       	call   80103fd0 <kill>
...
801057a3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801057a6:	e8 65 e0 ff ff       	call   80103810 <myproc>
...
801057c7:	78 27                	js     801057f0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
801057c9:	e8 42 e0 ff ff       	call   80103810 <myproc>
  if(growproc(n) < 0)
...
801057d6:	e8 55 e1 ff ff       	call   80103930 <growproc>
...
8010582d:	83 c4 10             	add    $0x10,%esp
  ...
  acquire(&tickslock);
  ticks0 = ticks;
80105830:	8b 1d a0 54 11 80    	mov    0x801154a0,%ebx
  while(ticks - ticks0 < n){
...
80105848:	68 a0 54 11 80       	push   $0x801154a0
8010584d:	e8 6e e5 ff ff       	call   80103dc0 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105852:	a1 a0 54 11 80       	mov    0x801154a0,%eax
...
801058b4:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801058b7:	68 60 4c 11 80       	push   $0x80114c60
801058bc:	e8 af ec ff ff       	call   80104570 <acquire>
  xticks = ticks;
801058c1:	8b 1d a0 54 11 80    	mov    0x801154a0,%ebx
  release(&tickslock);
801058c7:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
...
801058e9:	54                   	push   %esp
  call trap
801058ea:	e8 e1 00 00 00       	call   801059d0 <trap>
  addl $4, %esp
...
80105914:	c6 04 c5 a4 4c 11 80 	movb   $0x0,-0x7feeb35c(,%eax,8)
8010591b:	00 
8010591c:	66 89 0c c5 a2 4c 11 	mov    %cx,-0x7feeb35e(,%eax,8)
80105923:	80 
80105924:	c6 04 c5 a5 4c 11 80 	movb   $0x8e,-0x7feeb35b(,%eax,8)
8010592b:	8e 
8010592c:	66 89 14 c5 a0 4c 11 	mov    %dx,-0x7feeb360(,%eax,8)
80105933:	80 
80105934:	c1 ea 10             	shr    $0x10,%edx
80105937:	66 89 14 c5 a6 4c 11 	mov    %dx,-0x7feeb35a(,%eax,8)
8010593e:	80 
void
tvinit(void)
{
...
80105959:	68 b9 79 10 80       	push   $0x801079b9
8010595e:	68 60 4c 11 80       	push   $0x80114c60
{
  int i;
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105963:	66 89 15 a2 4e 11 80 	mov    %dx,0x80114ea2
8010596a:	c6 05 a4 4e 11 80 00 	movb   $0x0,0x80114ea4
80105971:	66 a3 a0 4e 11 80    	mov    %ax,0x80114ea0
80105977:	c1 e8 10             	shr    $0x10,%eax
8010597a:	c6 05 a5 4e 11 80 ef 	movb   $0xef,0x80114ea5
80105981:	66 a3 a6 4e 11 80    	mov    %ax,0x80114ea6

  initlock(&tickslock, "time");
80105987:	e8 e4 ea ff ff       	call   80104470 <initlock>
}
...
801059ab:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801059af:	b8 a0 4c 11 80       	mov    $0x80114ca0,%eax
...
801059f0:	ff 24 85 60 7a 10 80 	jmp    *-0x7fef85a0(,%eax,4)
...
80105a55:	68 1c 7a 10 80       	push   $0x80107a1c
...
80105adb:	75 a8                	jne    80105a85 <trap+0xb5>
    exit();
80105add:	e8 5e e1 ff ff       	call   80103c40 <exit>
...
80105aec:	75 ab                	jne    80105a99 <trap+0xc9>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();
80105aee:	e8 7d e2 ff ff       	call   80103d70 <yield>
...
80105aff:	0f 84 ab 00 00 00    	je     80105bb0 <trap+0x1e0>
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
    lapiceoi();
80105b05:	e8 06 cc ff ff       	call   80102710 <lapiceoi>
    break;
...
80105b0f:	90                   	nop
  ...
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80105b10:	e8 bb ca ff ff       	call   801025d0 <kbdintr>
    lapiceoi();
80105b15:	e8 f6 cb ff ff       	call   80102710 <lapiceoi>
    break;
...
80105b20:	e8 5b 02 00 00       	call   80105d80 <uartintr>
    lapiceoi();
80105b25:	e8 e6 cb ff ff       	call   80102710 <lapiceoi>
    break;
...
80105b3f:	68 c4 79 10 80       	push   $0x801079c4
80105b44:	e8 17 ab ff ff       	call   80100660 <cprintf>
            cpuid(), tf->cs, tf->eip);
    lapiceoi();
80105b49:	e8 c2 cb ff ff       	call   80102710 <lapiceoi>
    break;
...
80105b59:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80105b60:	e8 eb c4 ff ff       	call   80102050 <ideintr>
...
80105b81:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105b84:	e8 57 ef ff ff       	call   80104ae0 <syscall>
    if(myproc()->killed)
...
80105b9f:	5d                   	pop    %ebp
    ...
    if(myproc()->killed)
      exit();
80105ba0:	e9 9b e0 ff ff       	jmp    80103c40 <exit>
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
      exit();
80105ba8:	e8 93 e0 ff ff       	call   80103c40 <exit>
...
80105bc4:	83 05 a0 54 11 80 01 	addl   $0x1,0x801154a0
      wakeup(&ticks);
80105bcb:	e8 a0 e3 ff ff       	call   80103f70 <wakeup>
      release(&tickslock);
...
80105bf8:	68 e8 79 10 80       	push   $0x801079e8
80105bfd:	e8 5e aa ff ff       	call   80100660 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
80105c02:	83 c4 14             	add    $0x14,%esp
80105c05:	68 be 79 10 80       	push   $0x801079be
...
80105c65:	e8 c6 ca ff ff       	call   80102730 <microdelay>
{
  int i;
...
80105cff:	bb e0 7a 10 80       	mov    $0x80107ae0,%ebx
80105d04:	6a 00                	push   $0x0
80105d06:	6a 04                	push   $0x4
80105d08:	e8 93 c5 ff ff       	call   801022a0 <ioapicenable>
...
80105d97:	6a 00                	push   $0x0
  jmp alltraps
80105d99:	e9 3c fb ff ff       	jmp    801058da <alltraps>
...
80105da0:	6a 01                	push   $0x1
  jmp alltraps
80105da2:	e9 33 fb ff ff       	jmp    801058da <alltraps>
...
80105da9:	6a 02                	push   $0x2
  jmp alltraps
80105dab:	e9 2a fb ff ff       	jmp    801058da <alltraps>
...
80105db2:	6a 03                	push   $0x3
  jmp alltraps
80105db4:	e9 21 fb ff ff       	jmp    801058da <alltraps>
...
80105dbb:	6a 04                	push   $0x4
  jmp alltraps
80105dbd:	e9 18 fb ff ff       	jmp    801058da <alltraps>
...
80105dc4:	6a 05                	push   $0x5
  jmp alltraps
80105dc6:	e9 0f fb ff ff       	jmp    801058da <alltraps>
...
80105dcd:	6a 06                	push   $0x6
  jmp alltraps
80105dcf:	e9 06 fb ff ff       	jmp    801058da <alltraps>
...
80105dd6:	6a 07                	push   $0x7
  jmp alltraps
80105dd8:	e9 fd fa ff ff       	jmp    801058da <alltraps>
...
80105ddd:	6a 08                	push   $0x8
  jmp alltraps
80105ddf:	e9 f6 fa ff ff       	jmp    801058da <alltraps>
...
80105de6:	6a 09                	push   $0x9
  jmp alltraps
80105de8:	e9 ed fa ff ff       	jmp    801058da <alltraps>
...
80105df4:	6a 0b                	push   $0xb
  jmp alltraps
80105df6:	e9 df fa ff ff       	jmp    801058da <alltraps>
...
80105dfb:	6a 0c                	push   $0xc
  jmp alltraps
80105dfd:	e9 d8 fa ff ff       	jmp    801058da <alltraps>
...
80105e02:	6a 0d                	push   $0xd
  jmp alltraps
80105e04:	e9 d1 fa ff ff       	jmp    801058da <alltraps>
...
80105e09:	6a 0e                	push   $0xe
  jmp alltraps
80105e0b:	e9 ca fa ff ff       	jmp    801058da <alltraps>
...
80105e12:	6a 0f                	push   $0xf
  jmp alltraps
80105e14:	e9 c1 fa ff ff       	jmp    801058da <alltraps>
...
80105e2b:	6a 12                	push   $0x12
  jmp alltraps
80105e2d:	e9 a8 fa ff ff       	jmp    801058da <alltraps>
...
80105e34:	6a 13                	push   $0x13
  jmp alltraps
80105e36:	e9 9f fa ff ff       	jmp    801058da <alltraps>
...
80105e3d:	6a 14                	push   $0x14
  jmp alltraps
80105e3f:	e9 96 fa ff ff       	jmp    801058da <alltraps>
...
80105e46:	6a 15                	push   $0x15
  jmp alltraps
80105e48:	e9 8d fa ff ff       	jmp    801058da <alltraps>
...
80105e4f:	6a 16                	push   $0x16
  jmp alltraps
80105e51:	e9 84 fa ff ff       	jmp    801058da <alltraps>
...
80105e58:	6a 17                	push   $0x17
  jmp alltraps
80105e5a:	e9 7b fa ff ff       	jmp    801058da <alltraps>
...
80105e61:	6a 18                	push   $0x18
  jmp alltraps
80105e63:	e9 72 fa ff ff       	jmp    801058da <alltraps>
...
80105e6a:	6a 19                	push   $0x19
  jmp alltraps
80105e6c:	e9 69 fa ff ff       	jmp    801058da <alltraps>
...
80105e73:	6a 1a                	push   $0x1a
  jmp alltraps
80105e75:	e9 60 fa ff ff       	jmp    801058da <alltraps>
...
80105e7c:	6a 1b                	push   $0x1b
  jmp alltraps
80105e7e:	e9 57 fa ff ff       	jmp    801058da <alltraps>
...
80105e85:	6a 1c                	push   $0x1c
  jmp alltraps
80105e87:	e9 4e fa ff ff       	jmp    801058da <alltraps>
...
80105e8e:	6a 1d                	push   $0x1d
  jmp alltraps
80105e90:	e9 45 fa ff ff       	jmp    801058da <alltraps>
...
80105e97:	6a 1e                	push   $0x1e
  jmp alltraps
80105e99:	e9 3c fa ff ff       	jmp    801058da <alltraps>
...
80105ea0:	6a 1f                	push   $0x1f
  jmp alltraps
80105ea2:	e9 33 fa ff ff       	jmp    801058da <alltraps>
...
80105ea9:	6a 20                	push   $0x20
  jmp alltraps
80105eab:	e9 2a fa ff ff       	jmp    801058da <alltraps>
...
80105ebb:	6a 22                	push   $0x22
  jmp alltraps
80105ebd:	e9 18 fa ff ff       	jmp    801058da <alltraps>
...
80105ec4:	6a 23                	push   $0x23
  jmp alltraps
80105ec6:	e9 0f fa ff ff       	jmp    801058da <alltraps>
...
80105ecd:	6a 24                	push   $0x24
  jmp alltraps
80105ecf:	e9 06 fa ff ff       	jmp    801058da <alltraps>
...
80105ed6:	6a 25                	push   $0x25
  jmp alltraps
80105ed8:	e9 fd f9 ff ff       	jmp    801058da <alltraps>
...
80105edf:	6a 26                	push   $0x26
  jmp alltraps
80105ee1:	e9 f4 f9 ff ff       	jmp    801058da <alltraps>
...
80105ee8:	6a 27                	push   $0x27
  jmp alltraps
80105eea:	e9 eb f9 ff ff       	jmp    801058da <alltraps>
...
80105ef1:	6a 28                	push   $0x28
  jmp alltraps
80105ef3:	e9 e2 f9 ff ff       	jmp    801058da <alltraps>
...
80105efa:	6a 29                	push   $0x29
  jmp alltraps
80105efc:	e9 d9 f9 ff ff       	jmp    801058da <alltraps>
...
80105f03:	6a 2a                	push   $0x2a
  jmp alltraps
80105f05:	e9 d0 f9 ff ff       	jmp    801058da <alltraps>
...
80105f0c:	6a 2b                	push   $0x2b
  jmp alltraps
80105f0e:	e9 c7 f9 ff ff       	jmp    801058da <alltraps>
...
80105f15:	6a 2c                	push   $0x2c
  jmp alltraps
80105f17:	e9 be f9 ff ff       	jmp    801058da <alltraps>
...
80105f1e:	6a 2d                	push   $0x2d
  jmp alltraps
80105f20:	e9 b5 f9 ff ff       	jmp    801058da <alltraps>
...
80105f27:	6a 2e                	push   $0x2e
  jmp alltraps
80105f29:	e9 ac f9 ff ff       	jmp    801058da <alltraps>
...
80105f30:	6a 2f                	push   $0x2f
  jmp alltraps
80105f32:	e9 a3 f9 ff ff       	jmp    801058da <alltraps>
...
80105f39:	6a 30                	push   $0x30
  jmp alltraps
80105f3b:	e9 9a f9 ff ff       	jmp    801058da <alltraps>
...
80105f42:	6a 31                	push   $0x31
  jmp alltraps
80105f44:	e9 91 f9 ff ff       	jmp    801058da <alltraps>
...
80105f4b:	6a 32                	push   $0x32
  jmp alltraps
80105f4d:	e9 88 f9 ff ff       	jmp    801058da <alltraps>
...
80105f54:	6a 33                	push   $0x33
  jmp alltraps
80105f56:	e9 7f f9 ff ff       	jmp    801058da <alltraps>
...
80105f5d:	6a 34                	push   $0x34
  jmp alltraps
80105f5f:	e9 76 f9 ff ff       	jmp    801058da <alltraps>
...
80105f66:	6a 35                	push   $0x35
  jmp alltraps
80105f68:	e9 6d f9 ff ff       	jmp    801058da <alltraps>
...
80105f6f:	6a 36                	push   $0x36
  jmp alltraps
80105f71:	e9 64 f9 ff ff       	jmp    801058da <alltraps>
...
80105f78:	6a 37                	push   $0x37
  jmp alltraps
80105f7a:	e9 5b f9 ff ff       	jmp    801058da <alltraps>
...
80105f81:	6a 38                	push   $0x38
  jmp alltraps
80105f83:	e9 52 f9 ff ff       	jmp    801058da <alltraps>
...
80105f8a:	6a 39                	push   $0x39
  jmp alltraps
80105f8c:	e9 49 f9 ff ff       	jmp    801058da <alltraps>
...
80105f93:	6a 3a                	push   $0x3a
  jmp alltraps
80105f95:	e9 40 f9 ff ff       	jmp    801058da <alltraps>
...
80105f9c:	6a 3b                	push   $0x3b
  jmp alltraps
80105f9e:	e9 37 f9 ff ff       	jmp    801058da <alltraps>
...
80105fa5:	6a 3c                	push   $0x3c
  jmp alltraps
80105fa7:	e9 2e f9 ff ff       	jmp    801058da <alltraps>
...
80105fae:	6a 3d                	push   $0x3d
  jmp alltraps
80105fb0:	e9 25 f9 ff ff       	jmp    801058da <alltraps>
...
80105fb7:	6a 3e                	push   $0x3e
  jmp alltraps
80105fb9:	e9 1c f9 ff ff       	jmp    801058da <alltraps>
...
80105fc0:	6a 3f                	push   $0x3f
  jmp alltraps
80105fc2:	e9 13 f9 ff ff       	jmp    801058da <alltraps>
...
80105fc9:	6a 40                	push   $0x40
  jmp alltraps
80105fcb:	e9 0a f9 ff ff       	jmp    801058da <alltraps>
...
80105fd2:	6a 41                	push   $0x41
  jmp alltraps
80105fd4:	e9 01 f9 ff ff       	jmp    801058da <alltraps>
...
80105fdb:	6a 42                	push   $0x42
  jmp alltraps
80105fdd:	e9 f8 f8 ff ff       	jmp    801058da <alltraps>
...
80105fe4:	6a 43                	push   $0x43
  jmp alltraps
80105fe6:	e9 ef f8 ff ff       	jmp    801058da <alltraps>
...
80105fed:	6a 44                	push   $0x44
  jmp alltraps
80105fef:	e9 e6 f8 ff ff       	jmp    801058da <alltraps>
...
80105ff6:	6a 45                	push   $0x45
  jmp alltraps
80105ff8:	e9 dd f8 ff ff       	jmp    801058da <alltraps>
...
80105fff:	6a 46                	push   $0x46
  jmp alltraps
80106001:	e9 d4 f8 ff ff       	jmp    801058da <alltraps>
...
80106008:	6a 47                	push   $0x47
  jmp alltraps
8010600a:	e9 cb f8 ff ff       	jmp    801058da <alltraps>
...
80106011:	6a 48                	push   $0x48
  jmp alltraps
80106013:	e9 c2 f8 ff ff       	jmp    801058da <alltraps>
...
8010601a:	6a 49                	push   $0x49
  jmp alltraps
8010601c:	e9 b9 f8 ff ff       	jmp    801058da <alltraps>
...
80106023:	6a 4a                	push   $0x4a
  jmp alltraps
80106025:	e9 b0 f8 ff ff       	jmp    801058da <alltraps>
...
8010602c:	6a 4b                	push   $0x4b
  jmp alltraps
8010602e:	e9 a7 f8 ff ff       	jmp    801058da <alltraps>
...
80106035:	6a 4c                	push   $0x4c
  jmp alltraps
80106037:	e9 9e f8 ff ff       	jmp    801058da <alltraps>
...
8010603e:	6a 4d                	push   $0x4d
  jmp alltraps
80106040:	e9 95 f8 ff ff       	jmp    801058da <alltraps>
...
80106047:	6a 4e                	push   $0x4e
  jmp alltraps
80106049:	e9 8c f8 ff ff       	jmp    801058da <alltraps>
...
80106050:	6a 4f                	push   $0x4f
  jmp alltraps
80106052:	e9 83 f8 ff ff       	jmp    801058da <alltraps>
...
80106059:	6a 50                	push   $0x50
  jmp alltraps
8010605b:	e9 7a f8 ff ff       	jmp    801058da <alltraps>
...
80106062:	6a 51                	push   $0x51
  jmp alltraps
80106064:	e9 71 f8 ff ff       	jmp    801058da <alltraps>
...
8010606b:	6a 52                	push   $0x52
  jmp alltraps
8010606d:	e9 68 f8 ff ff       	jmp    801058da <alltraps>
...
80106074:	6a 53                	push   $0x53
  jmp alltraps
80106076:	e9 5f f8 ff ff       	jmp    801058da <alltraps>
...
8010607d:	6a 54                	push   $0x54
  jmp alltraps
8010607f:	e9 56 f8 ff ff       	jmp    801058da <alltraps>
...
80106086:	6a 55                	push   $0x55
  jmp alltraps
80106088:	e9 4d f8 ff ff       	jmp    801058da <alltraps>
...
8010608f:	6a 56                	push   $0x56
  jmp alltraps
80106091:	e9 44 f8 ff ff       	jmp    801058da <alltraps>
...
80106098:	6a 57                	push   $0x57
  jmp alltraps
8010609a:	e9 3b f8 ff ff       	jmp    801058da <alltraps>
...
801060a1:	6a 58                	push   $0x58
  jmp alltraps
801060a3:	e9 32 f8 ff ff       	jmp    801058da <alltraps>
...
801060aa:	6a 59                	push   $0x59
  jmp alltraps
801060ac:	e9 29 f8 ff ff       	jmp    801058da <alltraps>
...
801060b3:	6a 5a                	push   $0x5a
  jmp alltraps
801060b5:	e9 20 f8 ff ff       	jmp    801058da <alltraps>
...
801060bc:	6a 5b                	push   $0x5b
  jmp alltraps
801060be:	e9 17 f8 ff ff       	jmp    801058da <alltraps>
...
801060c5:	6a 5c                	push   $0x5c
  jmp alltraps
801060c7:	e9 0e f8 ff ff       	jmp    801058da <alltraps>
...
801060ce:	6a 5d                	push   $0x5d
  jmp alltraps
801060d0:	e9 05 f8 ff ff       	jmp    801058da <alltraps>
...
801060d7:	6a 5e                	push   $0x5e
  jmp alltraps
801060d9:	e9 fc f7 ff ff       	jmp    801058da <alltraps>
...
801060e0:	6a 5f                	push   $0x5f
  jmp alltraps
801060e2:	e9 f3 f7 ff ff       	jmp    801058da <alltraps>
...
801060e9:	6a 60                	push   $0x60
  jmp alltraps
801060eb:	e9 ea f7 ff ff       	jmp    801058da <alltraps>
...
801060f2:	6a 61                	push   $0x61
  jmp alltraps
801060f4:	e9 e1 f7 ff ff       	jmp    801058da <alltraps>
...
801060fb:	6a 62                	push   $0x62
  jmp alltraps
801060fd:	e9 d8 f7 ff ff       	jmp    801058da <alltraps>
...
80106104:	6a 63                	push   $0x63
  jmp alltraps
80106106:	e9 cf f7 ff ff       	jmp    801058da <alltraps>
...
8010610d:	6a 64                	push   $0x64
  jmp alltraps
8010610f:	e9 c6 f7 ff ff       	jmp    801058da <alltraps>
...
80106116:	6a 65                	push   $0x65
  jmp alltraps
80106118:	e9 bd f7 ff ff       	jmp    801058da <alltraps>
...
8010611f:	6a 66                	push   $0x66
  jmp alltraps
80106121:	e9 b4 f7 ff ff       	jmp    801058da <alltraps>
...
80106128:	6a 67                	push   $0x67
  jmp alltraps
8010612a:	e9 ab f7 ff ff       	jmp    801058da <alltraps>
...
80106131:	6a 68                	push   $0x68
  jmp alltraps
80106133:	e9 a2 f7 ff ff       	jmp    801058da <alltraps>
...
8010613a:	6a 69                	push   $0x69
  jmp alltraps
8010613c:	e9 99 f7 ff ff       	jmp    801058da <alltraps>
...
80106143:	6a 6a                	push   $0x6a
  jmp alltraps
80106145:	e9 90 f7 ff ff       	jmp    801058da <alltraps>
...
8010614c:	6a 6b                	push   $0x6b
  jmp alltraps
8010614e:	e9 87 f7 ff ff       	jmp    801058da <alltraps>
...
80106155:	6a 6c                	push   $0x6c
  jmp alltraps
80106157:	e9 7e f7 ff ff       	jmp    801058da <alltraps>
...
8010615e:	6a 6d                	push   $0x6d
  jmp alltraps
80106160:	e9 75 f7 ff ff       	jmp    801058da <alltraps>
...
80106167:	6a 6e                	push   $0x6e
  jmp alltraps
80106169:	e9 6c f7 ff ff       	jmp    801058da <alltraps>
...
80106170:	6a 6f                	push   $0x6f
  jmp alltraps
80106172:	e9 63 f7 ff ff       	jmp    801058da <alltraps>
...
80106179:	6a 70                	push   $0x70
  jmp alltraps
8010617b:	e9 5a f7 ff ff       	jmp    801058da <alltraps>
...
80106182:	6a 71                	push   $0x71
  jmp alltraps
80106184:	e9 51 f7 ff ff       	jmp    801058da <alltraps>
...
8010618b:	6a 72                	push   $0x72
  jmp alltraps
8010618d:	e9 48 f7 ff ff       	jmp    801058da <alltraps>
...
80106194:	6a 73                	push   $0x73
  jmp alltraps
80106196:	e9 3f f7 ff ff       	jmp    801058da <alltraps>
...
8010619d:	6a 74                	push   $0x74
  jmp alltraps
8010619f:	e9 36 f7 ff ff       	jmp    801058da <alltraps>
...
801061a6:	6a 75                	push   $0x75
  jmp alltraps
801061a8:	e9 2d f7 ff ff       	jmp    801058da <alltraps>
...
801061af:	6a 76                	push   $0x76
  jmp alltraps
801061b1:	e9 24 f7 ff ff       	jmp    801058da <alltraps>
...
801061b8:	6a 77                	push   $0x77
  jmp alltraps
801061ba:	e9 1b f7 ff ff       	jmp    801058da <alltraps>
...
801061c1:	6a 78                	push   $0x78
  jmp alltraps
801061c3:	e9 12 f7 ff ff       	jmp    801058da <alltraps>
...
801061ca:	6a 79                	push   $0x79
  jmp alltraps
801061cc:	e9 09 f7 ff ff       	jmp    801058da <alltraps>
...
801061d3:	6a 7a                	push   $0x7a
  jmp alltraps
801061d5:	e9 00 f7 ff ff       	jmp    801058da <alltraps>
...
801061dc:	6a 7b                	push   $0x7b
  jmp alltraps
801061de:	e9 f7 f6 ff ff       	jmp    801058da <alltraps>
...
801061e5:	6a 7c                	push   $0x7c
  jmp alltraps
801061e7:	e9 ee f6 ff ff       	jmp    801058da <alltraps>
...
801061ee:	6a 7d                	push   $0x7d
  jmp alltraps
801061f0:	e9 e5 f6 ff ff       	jmp    801058da <alltraps>
...
801061f7:	6a 7e                	push   $0x7e
  jmp alltraps
801061f9:	e9 dc f6 ff ff       	jmp    801058da <alltraps>
...
80106200:	6a 7f                	push   $0x7f
  jmp alltraps
80106202:	e9 d3 f6 ff ff       	jmp    801058da <alltraps>
...
80106209:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010620e:	e9 c7 f6 ff ff       	jmp    801058da <alltraps>
...
80106215:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010621a:	e9 bb f6 ff ff       	jmp    801058da <alltraps>
...
80106221:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106226:	e9 af f6 ff ff       	jmp    801058da <alltraps>
...
8010622d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106232:	e9 a3 f6 ff ff       	jmp    801058da <alltraps>
...
80106239:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010623e:	e9 97 f6 ff ff       	jmp    801058da <alltraps>
...
80106245:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010624a:	e9 8b f6 ff ff       	jmp    801058da <alltraps>
...
80106251:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106256:	e9 7f f6 ff ff       	jmp    801058da <alltraps>
...
8010625d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106262:	e9 73 f6 ff ff       	jmp    801058da <alltraps>
...
80106269:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010626e:	e9 67 f6 ff ff       	jmp    801058da <alltraps>
...
80106275:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010627a:	e9 5b f6 ff ff       	jmp    801058da <alltraps>
...
80106281:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106286:	e9 4f f6 ff ff       	jmp    801058da <alltraps>
...
8010628d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106292:	e9 43 f6 ff ff       	jmp    801058da <alltraps>
...
80106299:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010629e:	e9 37 f6 ff ff       	jmp    801058da <alltraps>
...
801062a5:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801062aa:	e9 2b f6 ff ff       	jmp    801058da <alltraps>
...
801062b1:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801062b6:	e9 1f f6 ff ff       	jmp    801058da <alltraps>
...
801062bd:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801062c2:	e9 13 f6 ff ff       	jmp    801058da <alltraps>
...
801062c9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801062ce:	e9 07 f6 ff ff       	jmp    801058da <alltraps>
...
801062d5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801062da:	e9 fb f5 ff ff       	jmp    801058da <alltraps>
...
801062e1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801062e6:	e9 ef f5 ff ff       	jmp    801058da <alltraps>
...
801062ed:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801062f2:	e9 e3 f5 ff ff       	jmp    801058da <alltraps>
...
801062f9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801062fe:	e9 d7 f5 ff ff       	jmp    801058da <alltraps>
...
80106305:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010630a:	e9 cb f5 ff ff       	jmp    801058da <alltraps>
...
80106311:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106316:	e9 bf f5 ff ff       	jmp    801058da <alltraps>
...
8010631d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106322:	e9 b3 f5 ff ff       	jmp    801058da <alltraps>
...
80106329:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010632e:	e9 a7 f5 ff ff       	jmp    801058da <alltraps>
...
80106335:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010633a:	e9 9b f5 ff ff       	jmp    801058da <alltraps>
...
80106341:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106346:	e9 8f f5 ff ff       	jmp    801058da <alltraps>
...
8010634d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106352:	e9 83 f5 ff ff       	jmp    801058da <alltraps>
...
80106359:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010635e:	e9 77 f5 ff ff       	jmp    801058da <alltraps>
...
80106365:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010636a:	e9 6b f5 ff ff       	jmp    801058da <alltraps>
...
80106371:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106376:	e9 5f f5 ff ff       	jmp    801058da <alltraps>
...
8010637d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106382:	e9 53 f5 ff ff       	jmp    801058da <alltraps>
...
80106389:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010638e:	e9 47 f5 ff ff       	jmp    801058da <alltraps>
...
80106395:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010639a:	e9 3b f5 ff ff       	jmp    801058da <alltraps>
...
801063a1:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801063a6:	e9 2f f5 ff ff       	jmp    801058da <alltraps>
...
801063ad:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801063b2:	e9 23 f5 ff ff       	jmp    801058da <alltraps>
...
801063b9:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801063be:	e9 17 f5 ff ff       	jmp    801058da <alltraps>
...
801063c5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801063ca:	e9 0b f5 ff ff       	jmp    801058da <alltraps>
...
801063d1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801063d6:	e9 ff f4 ff ff       	jmp    801058da <alltraps>
...
801063dd:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801063e2:	e9 f3 f4 ff ff       	jmp    801058da <alltraps>
...
801063e9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801063ee:	e9 e7 f4 ff ff       	jmp    801058da <alltraps>
...
801063f5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801063fa:	e9 db f4 ff ff       	jmp    801058da <alltraps>
...
80106401:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106406:	e9 cf f4 ff ff       	jmp    801058da <alltraps>
...
8010640d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106412:	e9 c3 f4 ff ff       	jmp    801058da <alltraps>
...
80106419:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010641e:	e9 b7 f4 ff ff       	jmp    801058da <alltraps>
...
80106425:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010642a:	e9 ab f4 ff ff       	jmp    801058da <alltraps>
...
80106431:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106436:	e9 9f f4 ff ff       	jmp    801058da <alltraps>
...
8010643d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106442:	e9 93 f4 ff ff       	jmp    801058da <alltraps>
...
80106449:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010644e:	e9 87 f4 ff ff       	jmp    801058da <alltraps>
...
80106455:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010645a:	e9 7b f4 ff ff       	jmp    801058da <alltraps>
...
80106461:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106466:	e9 6f f4 ff ff       	jmp    801058da <alltraps>
...
8010646d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106472:	e9 63 f4 ff ff       	jmp    801058da <alltraps>
...
80106479:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010647e:	e9 57 f4 ff ff       	jmp    801058da <alltraps>
...
80106485:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010648a:	e9 4b f4 ff ff       	jmp    801058da <alltraps>
...
80106491:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106496:	e9 3f f4 ff ff       	jmp    801058da <alltraps>
...
8010649d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801064a2:	e9 33 f4 ff ff       	jmp    801058da <alltraps>
...
801064a9:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801064ae:	e9 27 f4 ff ff       	jmp    801058da <alltraps>
...
801064b5:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801064ba:	e9 1b f4 ff ff       	jmp    801058da <alltraps>
...
801064c1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801064c6:	e9 0f f4 ff ff       	jmp    801058da <alltraps>
...
801064cd:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801064d2:	e9 03 f4 ff ff       	jmp    801058da <alltraps>
...
801064d9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801064de:	e9 f7 f3 ff ff       	jmp    801058da <alltraps>
...
801064e5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801064ea:	e9 eb f3 ff ff       	jmp    801058da <alltraps>
...
801064f1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801064f6:	e9 df f3 ff ff       	jmp    801058da <alltraps>
...
801064fd:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106502:	e9 d3 f3 ff ff       	jmp    801058da <alltraps>
...
80106509:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010650e:	e9 c7 f3 ff ff       	jmp    801058da <alltraps>
...
80106515:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010651a:	e9 bb f3 ff ff       	jmp    801058da <alltraps>
...
80106521:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106526:	e9 af f3 ff ff       	jmp    801058da <alltraps>
...
8010652d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106532:	e9 a3 f3 ff ff       	jmp    801058da <alltraps>
...
80106539:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010653e:	e9 97 f3 ff ff       	jmp    801058da <alltraps>
...
80106545:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010654a:	e9 8b f3 ff ff       	jmp    801058da <alltraps>
...
80106551:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106556:	e9 7f f3 ff ff       	jmp    801058da <alltraps>
...
8010655d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106562:	e9 73 f3 ff ff       	jmp    801058da <alltraps>
...
80106569:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010656e:	e9 67 f3 ff ff       	jmp    801058da <alltraps>
...
80106575:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010657a:	e9 5b f3 ff ff       	jmp    801058da <alltraps>
...
80106581:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106586:	e9 4f f3 ff ff       	jmp    801058da <alltraps>
...
8010658d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106592:	e9 43 f3 ff ff       	jmp    801058da <alltraps>
...
80106599:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010659e:	e9 37 f3 ff ff       	jmp    801058da <alltraps>
...
801065a5:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801065aa:	e9 2b f3 ff ff       	jmp    801058da <alltraps>
...
801065b1:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801065b6:	e9 1f f3 ff ff       	jmp    801058da <alltraps>
...
801065bd:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801065c2:	e9 13 f3 ff ff       	jmp    801058da <alltraps>
...
801065c9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801065ce:	e9 07 f3 ff ff       	jmp    801058da <alltraps>
...
801065d5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801065da:	e9 fb f2 ff ff       	jmp    801058da <alltraps>
...
801065e1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801065e6:	e9 ef f2 ff ff       	jmp    801058da <alltraps>
...
801065ed:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801065f2:	e9 e3 f2 ff ff       	jmp    801058da <alltraps>
...
801065f9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801065fe:	e9 d7 f2 ff ff       	jmp    801058da <alltraps>
...
80106605:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010660a:	e9 cb f2 ff ff       	jmp    801058da <alltraps>
...
80106611:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106616:	e9 bf f2 ff ff       	jmp    801058da <alltraps>
...
8010661d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106622:	e9 b3 f2 ff ff       	jmp    801058da <alltraps>
...
80106629:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010662e:	e9 a7 f2 ff ff       	jmp    801058da <alltraps>
...
80106635:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010663a:	e9 9b f2 ff ff       	jmp    801058da <alltraps>
...
80106641:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106646:	e9 8f f2 ff ff       	jmp    801058da <alltraps>
...
8010664d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106652:	e9 83 f2 ff ff       	jmp    801058da <alltraps>
...
80106659:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010665e:	e9 77 f2 ff ff       	jmp    801058da <alltraps>
...
80106665:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010666a:	e9 6b f2 ff ff       	jmp    801058da <alltraps>
...
80106671:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106676:	e9 5f f2 ff ff       	jmp    801058da <alltraps>
...
8010667d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106682:	e9 53 f2 ff ff       	jmp    801058da <alltraps>
...
80106689:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010668e:	e9 47 f2 ff ff       	jmp    801058da <alltraps>
...
80106695:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010669a:	e9 3b f2 ff ff       	jmp    801058da <alltraps>
...
801066a1:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801066a6:	e9 2f f2 ff ff       	jmp    801058da <alltraps>
...
801066ad:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801066b2:	e9 23 f2 ff ff       	jmp    801058da <alltraps>
...
801066b9:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801066be:	e9 17 f2 ff ff       	jmp    801058da <alltraps>
...
801066c5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801066ca:	e9 0b f2 ff ff       	jmp    801058da <alltraps>
...
801066d1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801066d6:	e9 ff f1 ff ff       	jmp    801058da <alltraps>
...
801066dd:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801066e2:	e9 f3 f1 ff ff       	jmp    801058da <alltraps>
...
801066e9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801066ee:	e9 e7 f1 ff ff       	jmp    801058da <alltraps>
...
801066f5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801066fa:	e9 db f1 ff ff       	jmp    801058da <alltraps>
...
80106701:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106706:	e9 cf f1 ff ff       	jmp    801058da <alltraps>
...
8010670d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106712:	e9 c3 f1 ff ff       	jmp    801058da <alltraps>
...
80106719:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010671e:	e9 b7 f1 ff ff       	jmp    801058da <alltraps>
...
80106725:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010672a:	e9 ab f1 ff ff       	jmp    801058da <alltraps>
...
80106731:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106736:	e9 9f f1 ff ff       	jmp    801058da <alltraps>
...
8010673d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106742:	e9 93 f1 ff ff       	jmp    801058da <alltraps>
...
80106749:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010674e:	e9 87 f1 ff ff       	jmp    801058da <alltraps>
...
80106755:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010675a:	e9 7b f1 ff ff       	jmp    801058da <alltraps>
...
80106761:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106766:	e9 6f f1 ff ff       	jmp    801058da <alltraps>
...
8010676d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106772:	e9 63 f1 ff ff       	jmp    801058da <alltraps>
...
80106779:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010677e:	e9 57 f1 ff ff       	jmp    801058da <alltraps>
...
80106785:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010678a:	e9 4b f1 ff ff       	jmp    801058da <alltraps>
...
80106791:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106796:	e9 3f f1 ff ff       	jmp    801058da <alltraps>
...
8010679d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801067a2:	e9 33 f1 ff ff       	jmp    801058da <alltraps>
...
801067a9:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801067ae:	e9 27 f1 ff ff       	jmp    801058da <alltraps>
...
801067b5:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801067ba:	e9 1b f1 ff ff       	jmp    801058da <alltraps>
...
801067c1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801067c6:	e9 0f f1 ff ff       	jmp    801058da <alltraps>
...
801067cd:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801067d2:	e9 03 f1 ff ff       	jmp    801058da <alltraps>
...
801067d9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801067de:	e9 f7 f0 ff ff       	jmp    801058da <alltraps>
...
801067e5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801067ea:	e9 eb f0 ff ff       	jmp    801058da <alltraps>
...
801067f1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801067f6:	e9 df f0 ff ff       	jmp    801058da <alltraps>
...
801067fd:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106802:	e9 d3 f0 ff ff       	jmp    801058da <alltraps>
...
80106854:	e8 37 bc ff ff       	call   80102490 <kalloc>
...
8010690d:	68 e8 7a 10 80       	push   $0x80107ae8
...
80106964:	e8 77 b9 ff ff       	call   801022e0 <kfree>
      *pte = 0;
...
80106ac0:	a1 a4 54 11 80       	mov    0x801154a4,%eax
...
80106b04:	0f 84 c4 00 00 00    	je     80106bce <switchuvm+0xee>
  ...
  pushcli();
80106b0a:	e8 21 da ff ff       	call   80104530 <pushcli>
...
80106bbb:	5d                   	pop    %ebp
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
80106bbc:	e9 5f da ff ff       	jmp    80104620 <popcli>
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
...
80106bc4:	68 ee 7a 10 80       	push   $0x80107aee
...
80106bd1:	68 19 7b 10 80       	push   $0x80107b19
...
80106bde:	68 04 7b 10 80       	push   $0x80107b04
...
80106c0b:	77 49                	ja     80106c56 <inituvm+0x66>
  ...
  mem = kalloc();
80106c0d:	e8 7e b8 ff ff       	call   80102490 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106c1f:	e8 bc da ff ff       	call   801046e0 <memset>
...
80106c50:	5d                   	pop    %ebp
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
80106c51:	e9 3a db ff ff       	jmp    80104790 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
...
80106c59:	68 2d 7b 10 80       	push   $0x80107b2d
...
80106ce1:	e8 6a ac ff ff       	call   80101950 <readi>
...
80106d0d:	68 47 7b 10 80       	push   $0x80107b47
...
80106d1a:	68 e8 7b 10 80       	push   $0x80107be8
...
80106d73:	e8 68 d9 ff ff       	call   801046e0 <memset>
...
80106da1:	76 7d                	jbe    80106e20 <allocuvm+0xf0>
    mem = kalloc();
80106da3:	e8 e8 b6 ff ff       	call   80102490 <kalloc>
    if(mem == 0){
...
80106db1:	68 65 7b 10 80       	push   $0x80107b65
...
80106de3:	68 7d 7b 10 80       	push   $0x80107b7d
...
80106e06:	e8 d5 b4 ff ff       	call   801022e0 <kfree>
      return 0;
...
80106eae:	e8 2d b4 ff ff       	call   801022e0 <kfree>
...
80106ec3:	5d                   	pop    %ebp
  ...
  kfree((char*)pgdir);
80106ec4:	e9 17 b4 ff ff       	jmp    801022e0 <kfree>
freevm(pde_t *pgdir)
{
  uint i;
...
80106ecc:	68 99 7b 10 80       	push   $0x80107b99
...
80106ee5:	e8 a6 b5 ff ff       	call   80102490 <kalloc>
...
80106f00:	e8 db d7 ff ff       	call   801046e0 <memset>
...
80106f6b:	a3 a4 54 11 80       	mov    %eax,0x801154a4
...
80106f9f:	68 aa 7b 10 80       	push   $0x80107baa
...
80107044:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
8010704a:	e8 41 b4 ff ff       	call   80102490 <kalloc>
...
80107082:	68 ce 7b 10 80       	push   $0x80107bce
...
8010708f:	68 b4 7b 10 80       	push   $0x80107bb4
...
8010711f:	e8 6c d6 ff ff       	call   80104790 <memmove>
    len -= n;
    buf += n;
